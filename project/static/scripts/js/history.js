        ...
        return (
          React.createElement("tr", {key:  index }, 
            ...
            React.createElement("td", null, 
              React.createElement(ActionComponent, {status: item.status, finishItem:  _this.props.finishItem.bind(null, item[".key"]), cancelItem:  _this.props.cancelItem.bind(null, item[".key"]), repostItem:  _this.props.repostItem.bind(null, item[".key"]) })
            )
          )
        );
      }
      ...
      React.createElement("div", null, 
        ...
        clickIP: this.statusfilterIP, clickA: this.statusfilterA, clickCanceled: this.statusfilterCanceled, clickExpired: this.statusfilterExpired}), 
          React.createElement("table", {className: "table table-striped"}, 
            ...
            React.createElement(QuestionPost, {items:  this.state.items, finishItem: this.finishItem, cancelItem:  this.cancelItem, repostItem:  this.repostItem, statusFilter: this.state.status_filter})
          ), 
